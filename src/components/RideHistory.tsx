              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="flex items-center mt-1">
                    ...
                    {formatDistance(stats.distance)} journey
                  </CardDescription>
                </div>
            ...
            <CardContent>
              <div className="flex justify-between items-center py-1">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{formatDuration(stats.duration)}</span>
                </div>
                <div className="flex items-center">
                  <ArrowUpDown size={16} className="mr-2 text-muted-foreground" />
                  <span className="text-sm">{stats.suddenStops + stats.suddenAccelerations} events</span>
                </div>
              </div>
